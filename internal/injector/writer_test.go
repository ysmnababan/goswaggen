...
func TestInjectComment_CommentBetweenFunction(t *testing.T) {
	fset := token.NewFileSet()
	mainFile := `
package main
...
func TestInjectComment_LastComment(t *testing.T) {
	fset := token.NewFileSet()
	mainFile := `
package main
...
func TestInjectComment_FirstComment(t *testing.T) {
	fset := token.NewFileSet()
	mainFile := `
package main
...
func TestInjectComment_OverwriteComment(t *testing.T) {
	fset := token.NewFileSet()
	mainFile := `
package main
